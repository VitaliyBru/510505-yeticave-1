<main>
    <?= $nav_panel; ?>
    <form class="form container<?= $errors['form'] ? ' form--invalid' : ''; ?>" action="sing-up.php" method="post"
        ...
        <div class="form__item<?= $errors['email'] ? ' form__item--invalid' : ''; ?>"> <!-- form__item--invalid -->
            ...
            <input id="email" type="text" name="user[email]" placeholder="Введите e-mail"
                   value="<?= secure($user['email']); ?>" required>
        ...
        <div class="form__item<?= $errors['password'] ? ' form__item--invalid' : ''; ?>">
            ...
            <input id="password" type="text" name="user[password]" placeholder="Введите пароль"
                   value="<?= secure($user['password']); ?>" required>
        ...
        <div class="form__item<?= $errors['name'] ? ' form__item--invalid' : ''; ?>">
            ...
            <input id="name" type="text" name="user[name]" placeholder="Введите имя"
                   value="<?= secure($user['name']); ?>" required>
            <span class="form__error">Введите имя</span>
        </div>
        <div class="form__item<?= $errors['contact'] ? ' form__item--invalid' : ''; ?>">
            <label for="message">Контактные данные*</label>
            <textarea id="message" name="user[contact]"
                      placeholder="Напишите как с вами связаться" required><?= secure($user['contact']); ?></textarea>
